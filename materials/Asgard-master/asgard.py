    ...
    def FKMoveArt5(self): # En realidad esto no va así, hay que calcular el movimiento acoplado. Proximamente.
        if s0.isOpen():
            if self.G1MoveRadioButton.isChecked():
                ...
                typeOfMovement="G0 "
                feedRate=""
            message=typeOfMovement + "Y" + str(self.SpinBoxArt5.value()//25) + feedRate
            messageToSend = message + "\n"
            messageToConsole = ">>> " + message
            s0.write(messageToSend.encode('UTF-8'))
            self.ConsoleOutput.appendPlainText(messageToConsole)
    ...
    def FKMoveArt6(self): # En realidad esto no va así, hay que calcular el movimiento acoplado. Proximamente.
        if s0.isOpen():
            if self.G1MoveRadioButton.isChecked():
                ...
                typeOfMovement="G0 "
                feedRate=""
            message=typeOfMovement + "Z" + str(self.SpinBoxArt6.value()//25) + feedRate
            messageToSend = message + "\n"
            messageToConsole = ">>> " + message
            s0.write(messageToSend.encode('UTF-8'))
            self.ConsoleOutput.appendPlainText(messageToConsole)
    ...
    def FKMoveAll(self): # En realidad esto no va así, hay que calcular el movimiento acoplado. Proximamente.
        if s0.isOpen():
            if self.G1MoveRadioButton.isChecked():
                ...
                typeOfMovement="G0 "
                feedRate=""
            message=typeOfMovement + "A" + str(self.SpinBoxArt1.value()) + " B" + str(self.SpinBoxArt2.value()) + " C" + str(self.SpinBoxArt2.value()) + " D" + str(self.SpinBoxArt3.value()) + " X" + str(self.SpinBoxArt4.value()) + " Y" + str(self.SpinBoxArt5.value()//25) + " Z" + str(self.SpinBoxArt6.value()//25) + feedRate
            messageToSend = message + "\n"
            messageToConsole = ">>> " + message
            s0.write(messageToSend.encode('UTF-8'))
            self.ConsoleOutput.appendPlainText(messageToConsole)
